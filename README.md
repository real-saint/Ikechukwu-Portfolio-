...
<head>
  ...
  <style>
    ...
    body {
      ...
      background-image: linear-gradient(to right, rgba(0,0,0,0.7), rgba(0,0,50,0.7)), url('A_digital_illustration_in_technology_and_artificia.png');
...
<body>
  ...
  </header>  <section id="about" class="about-me">
    <h2>About Me</h2>
